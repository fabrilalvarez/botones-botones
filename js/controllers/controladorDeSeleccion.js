    ...
    $("input").mousedown(function (e) {
        ...
        switch (this.name) {
            ...
            case "showSelectedText1":
                alert($ta.showSelectedText1());
                break;
            case "showSelectedText2":
                alert($ta.showSelectedText2());
                break;
            case "showSelectedText3":
                alert($ta.showSelectedText3());
                break;
            case "showSelectedText4":
                alert($ta.showSelectedText4());
                break;
            case "showSelectedText5":
                alert($ta.showSelectedText5());
                break;
