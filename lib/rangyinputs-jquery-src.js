...
(function ($) {
    ...
    var showSelectedText0, showSelectedText1, showSelectedText2, showSelectedText3, showSelectedText4;
    ...
    $(document).ready(function () {
        ...
        /** ESTA PARTE SE PUEDE OPTIMIZAR PARA MEJORAR EL CODIGO*/
        showSelectedText0 = function (el) {
            return getSelection(el).start + "#$" + getSelection(el).end + "#$" + getSelection(el).text + "#$0";
        };
        showSelectedText1 = function (el) {
            return getSelection(el).start + "#$" + getSelection(el).end + "#$" + getSelection(el).text + "#$1";
        };
        showSelectedText2 = function (el) {
            return getSelection(el).start + "#$" + getSelection(el).end + "#$" + getSelection(el).text + "#$2";
        };
        showSelectedText3 = function (el) {
            return getSelection(el).start + "#$" + getSelection(el).end + "#$" + getSelection(el).text + "#$3";
        };
        showSelectedText4 = function (el) {
            return getSelection(el).start + "#$" + getSelection(el).end + "#$" + getSelection(el).text + "#$4";
        };
        /**----------------------------------------------*/
        ...
        $.fn.extend({
            ...
            showSelectedText0: jQuerify(showSelectedText0, false),
            showSelectedText1: jQuerify(showSelectedText1, false),
            showSelectedText2: jQuerify(showSelectedText2, false),
            showSelectedText3: jQuerify(showSelectedText3, false),
            showSelectedText4: jQuerify(showSelectedText4, false),
