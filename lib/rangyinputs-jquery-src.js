...
(function ($) {
    ...
    var showSelectedText1, showSelectedText2, showSelectedText3, showSelectedText4, showSelectedText5;
    ...
    $(document).ready(function () {
        ...
        showSelectedText5 = function (el) {
            return getSelection(el).start + " " + getSelection(el).end + getSelection(el).text + " 5";
        };
        /**----------------------------------------------*/
        ...
        $.fn.extend({
            ...
            showSelectedText5: jQuerify(showSelectedText5, false),
